...
size_t crustify_av_strnlen(const char *s, size_t len);
int crustify_av_tolower(int value);
int crustify_av_toupper(int value);
unsigned crustify_av_zero_extend_c(unsigned value, unsigned bits);
int crustify_av_popcount_c(uint32_t value);
int crustify_av_popcount64_c(uint64_t value);
int crustify_av_parity_c(uint32_t value);
int crustify_av_sat_add32_c(int a, int b);
int crustify_av_sat_sub32_c(int a, int b);
int crustify_av_sat_dadd32_c(int a, int b);
int crustify_av_sat_dsub32_c(int a, int b);
int64_t crustify_av_sat_add64_c(int64_t a, int64_t b);
int64_t crustify_av_sat_sub64_c(int64_t a, int64_t b);
