...
fn main() {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .allowlist_type("^(AVDOVIDmData|AVDOVIDmLevel(2|11|254|255))$")
        .allowlist_function(
        ...
        .allowlist_type(
            "^AVIAMF((ParamDefinition|SubmixLayout)Type|ReconGain|Submix|SubmixElement|SubmixLayout)$",
        )
        ...
        .allowlist_function("^crustify_av_dovi_get_(ext|header|mapping)$")
        ...
        .allowlist_function("^av_opt_(child_class_iterate|get_chlayout|set_chlayout)$")
